...
export default function SubAdminSignInPwSearchComponent () {
    ...
    const onSubmitPhone=(e)=>{
        ...
        axios({
            url:'http://eyou46.dothome.co.kr/rankingdak/rankingdak_admin_pw_search_phone.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
    ...
    const onSubmitEmail=(e)=>{
        ...
        axios({
            url:'http://eyou46.dothome.co.kr/rankingdak/rankingdak_admin_pw_search_email.php',
            method:'POST',
            data: formData 
        })
        .then((res)=>{
